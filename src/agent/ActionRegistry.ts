...
export const CORE_AGENT_ACTIONS: AgentActionDefinition[] = [
  ...
  // ==================== CONVERSATION ====================
  {
    ...
    aliases: ['bắt đầu nghe', 'bật nghe thoại', 'nghe giúp tôi', 'bắt đầu ghi âm'],
  },
  {
    ...
    category: 'conversation',
    aliases: ['tạm dừng nghe', 'tạm dừng', 'ngừng nghe tạm thời'],
  },
  {
    ...
    category: 'conversation',
    aliases: ['dừng nghe', 'dừng ghi âm', 'kết thúc nghe', 'xong rồi'],
  },
  {
    ...
    category: 'conversation',
    aliases: ['tóm tắt cuộc trò chuyện', 'tóm tắt lời nói', 'họ dặn gì', 'bác sĩ nói gì'],
  },
  {
    ...
    category: 'conversation',
    aliases: ['việc cần làm từ cuộc nói chuyện', 'lời dặn', 'phải làm gì sau đó'],
  },
